...
# Define function to extract province random effects from the best model
...
# ZONAL STATS
#---------------------------------
# Function for aggregating to National total population and calculating uncertainties 
...
#  Function for aggregating to CU total population and calculating uncertainties  
...
shp <- as(st_geometry(shp_png), "Spatial")
plot(shp)
